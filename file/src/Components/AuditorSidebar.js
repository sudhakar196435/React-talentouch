...
import { UserOutlined, UnorderedListOutlined, FileSearchOutlined, LogoutOutlined } from '@ant-design/icons';
...
const items = [
  ...
  },
  {
    ...
    label: <Link to="/reports">View Reports</Link>,
  },
  {
    key: 'searchActs',
    icon: <FileSearchOutlined />,
    label: <Link to="/search">Search Acts</Link>,
  },
];
